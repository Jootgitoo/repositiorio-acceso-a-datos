...
public class ControladorCarpeta implements ActionListener {
  ...
  public void actionPerformed (ActionEvent evento) {
    switch (evento.getActionCommand()) {
      ...
      case InterfazVista.OBETENER_CONTENIDO_CARPETA_CLASE_NIO -> {
          Path archivo = Paths.get(this.vista.getRuta());
          ArrayList<String> contenidoDirectorio = this.modelo.mostrarContenidoDirectorio(archivo);
          String resultadoInformacion = contenidoDirectorio.toString();
          this.vista.escribeResultado(resultadoInformacion);
          this.vista.limpiarCampos();
      }
      case InterfazVista.BORRAR_FICHEROS_CARPETA_CLASE_NIO -> {
          Path nombreArchivo = Paths.get(this.vista.getRuta());
          File archivo = new File(this.vista.getRuta());
          this.modelo.borrarAlgo(nombreArchivo);
          this.vista.operacionExitosa();
          this.vista.limpiarCampos();
      }
